...
namespace Windows_OnOff
{
    internal class Translator
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> dictionary = new Dictionary<string, Dictionary<string, string>>
       {
             ...
             {"logOn",new Dictionary<string, string>{{"en", "The Windows System has been started." },{"de", "Das Windows System wurde gestarted." }}},
             {"loggedOut",new Dictionary<string, string>{{"en", "The Windows System has been stoped." },{"de", "Das Windows System wurde gestoped." } }},
             {"lock",new Dictionary<string, string>{{"en", "The Windows System has been locked." },{"de", "Das System wurde gesperrt." } }},
             {"unlock",new Dictionary<string, string>{{"en", "The Windows System has been unlocked." },{"de", "Das System wurde entsperrt." } }},
             {"serviceStart",new Dictionary<string, string>{{"en", "The Windows Service has been started." },{"de", "Die Windows Service wurde gestartet." } }},
             {"serviceStop",new Dictionary<string, string>{{"en", "The Windows Service has been stoped." },{"de", "Die Windows Service wurde gestoppt." } }},
             {"networkChange",new Dictionary<string, string>{{"en", "The Windows Service is back online." },{"de", "Die Windows Service ist wieder Online." } }},
